...
class otherTopK:
    ...
    def findTopKSeeds(self):
        ...
        print("betweenes centrality computed 2/5")
        ...
        print("closeness centrality computed 3/5")
        ...
        print("eigenvetor centrality computed 4/5")
        ...
        print("betweenes centrality computed 5/5")
